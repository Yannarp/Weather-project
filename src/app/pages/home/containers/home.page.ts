...
export class HomePage implements OnInit, OnDestroy {
  ...
  bookmarksList$: Observable<Bookmark[]> | undefined;
  isCurrentFavorite$: Observable<boolean> | undefined;

  searchControl: FormControl | undefined;
  searchControlWithAutocomplete: FormControl | undefined;
